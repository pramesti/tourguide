        ...
        <div class="container box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-end">
              <li class="nav-item active"><a class="nav-link" href="<?= base_url() ?>assets/index.html">Home</a></li> 
    ...
    <div class="container">
      ...
      <div class="row align-items-center text-center text-md-left">
        <div class="col-md-6 col-lg-5 mb-5 mb-md-0">
          ...
          <a class="button button-hero mt-4" href="<?= base_url('Login') ?>">Get Started</a>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img style="width:70%" class="img-fluid" src="<?= base_url() ?>assets/img/home/location_suggestion.png" alt="">
            </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img style="width:80%" class="img-fluid" src="<?= base_url() ?>assets/img/home/location_booking.png" alt="">
            </div>
            <div class="service-card-body">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img style="width:70%" class="img-fluid" src="<?= base_url() ?>assets/img/home/location_ticket.png" alt="">
            </div>
            <div class="service-card-body">
    ...
    <div class="container">
      <div class="row">
        ...
        <h2>Masih Nunggu Apa? <br class="d-none d-xl-block"> Jangan Diambil Pusing! <br class="d-none d-xl-block">Pesen Sekarang Juga!</h2>
          <p>Rasa puas dan seneng kalian itu kebahagiaan tersendiri bagi kita. Udah langsung aja liat-liat paket kita dulu, kalo cocok bungkus!</p>
        </div>
      </div>
    </div>
  </section>
